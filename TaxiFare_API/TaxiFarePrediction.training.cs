    ...
    public partial class TaxiFarePrediction
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")})      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=198,MinimumExampleCountPerLeaf=2,NumberOfTrees=32768,MaximumBinCountPerFeature=1024,LearningRate=1F,FeatureFraction=0.561022802582991F,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features"}));
